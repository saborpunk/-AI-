...
public interface KnowledgeArticleMapper extends BaseMapper<KnowledgeArticle> {
    ...
    int insertRow(@Param("id") String id, @Param("title") String title, @Param("content") String content, @Param("categoryId") String categoryId);
    ...
    int updateVersioned(@Param("id") String id, @Param("title") String title, @Param("content") String content, @Param("categoryId") String categoryId, @Param("version") long version);
